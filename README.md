...
- [Домашняя работа №2](#домашняя-работа-2)
  ...
  - [3. Дашборды](#3-Дашборды)
   - [3.1 Дашборд Активности пользователей и Размера тетрадок Jupyterhub.](#3-1-дашборд-активности-пользователей-и-размера-тетрадок-jupyterhub)
  - [Заключение](#Заключение)
...
### 3.2 Дашборд размера таблиц в PostgreSQL, а так же динамика добавления данных в таблицы, гистаграммы отражают размер таблиц, а временной ряд показывает когда в таблицы добавлялись данные и в каком объеме

Метрика:
- table_sizes_size_bytes - была определена внутри **[queries.yaml](https://github.com/Zubaev/jupyterhub_docker_postgres/blob/main/postgres-exporter/queries.yaml)** отражает топ 10 самых больших таблиц и их пользователей в моем случае таблицы 4 поэтому показано только 4
