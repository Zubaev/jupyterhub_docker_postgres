...
Почему то у меня дохли виртуальные машины, пока не отказался от серверной версии в пользу обычной Ублюнты 24.04.1 с графическим интерфейсом (Да не уровень, да колхоз, да ФЕВОПСЫ не поймут, но по другому вообще не работало стока раз умирали эти без интерфейсные машины)
