...
- [Домашняя работа №2](#домашняя-работа-2)
  - [1.Используемые инструменты для мониторинга, сбора метрик и визуализации.](#1-Используемые-инструменты-для-мониторинга-сбора-метрик-и-визуализации)
  - [Скриншоты](#Скриншоты)
  - [Заключение](#Заключение)
...
***
## 1. Используемые инструменты для мониторинга, сбора метрик и визуализации.
